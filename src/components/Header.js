        ...
        <Container fluid>
          ...
          <Nav className="ms-auto">
            <div className={styles["menu-item"]}>
              <Nav.Link onClick={() => showPage({ home: true })} href="#home">
                BRANDS
              </Nav.Link>
            </div>
            <div className={styles["menu-item"]}>
              <Nav.Link
                onClick={() => showPage({ register: true })}
                href="#register"
              >
                REGISTER
              </Nav.Link>
